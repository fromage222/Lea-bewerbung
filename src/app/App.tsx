...
import zdfLogo from 'figma:asset/ed6cb995c3d30d80020eebd2f00ffc8c687d4f0f.png';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-neutral-100 py-12 px-4 sm:px-6 lg:px-8 print:p-0 print:bg-white font-sans selection:bg-[#FF6600] selection:text-white">
      {/* PDF Export Button */}
      <div className="max-w-5xl mx-auto mb-4 flex justify-end print:hidden">
        <button
          onClick={exportToPDF}
          className="flex items-center gap-2 bg-[#FF6600] hover:bg-[#e55a00] text-white font-semibold text-sm px-5 py-2.5 rounded-full shadow-lg transition-all duration-200 hover:shadow-xl hover:scale-105 active:scale-95"
        >
      ...
      <div className="max-w-5xl mx-auto bg-white shadow-2xl rounded-sm overflow-hidden flex flex-col md:flex-row print:shadow-none print:overflow-visible">
        ...
        <div className="w-full md:w-[35%] bg-neutral-50 p-10 border-r border-neutral-200 flex flex-col relative print:after:content-[''] print:after:absolute print:after:top-full print:after:left-0 print:after:-right-[1px] print:after:h-[3000px] print:after:bg-neutral-50 print:after:border-r print:after:border-neutral-200 print:after:z-0">
          <div className="flex flex-col items-center mb-16">
             <div className="w-48 h-48 rounded-full overflow-hidden mb-8 border-4 border-[#FF6600] shadow-lg">
                <img 
                  src={profilbild} 
                  alt="Lea Koch" 
             ...
             <h1 className="text-4xl font-extrabold text-neutral-900 tracking-tight text-center uppercase">
               LEA <span className="text-[#FF6600]">KOCH</span>
             </h1>
          ...
          <div className="space-y-12">
             <Section>
                <SectionHeader icon={<User className="w-5 h-5 text-[#FF6600]" />} title="Kontakt" />
             ...
             <Section>
                <SectionHeader icon={<Globe className="w-5 h-5 text-[#FF6600]" />} title="Sprachen" />
                <div className="space-y-3 text-sm text-neutral-700">
                  <div className="flex justify-between items-center border-b border-neutral-200 pb-2">
                    <span className="font-medium">Deutsch</span>
                    <span className="text-[#FF6600] font-semibold">Muttersprache</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-neutral-200 pb-2">
                    <span className="font-medium">Englisch</span>
                    <span className="text-[#FF6600] font-semibold">B2</span>
                  </div>
                  <div className="flex justify-between items-center pb-2">
                    <span className="font-medium">Spanisch</span>
                    <span className="text-[#FF6600] font-semibold">B1</span>
                  </div>
                </div>
             </Section>
          </div>
  ...
  return (
    <h2 className="text-2xl font-bold text-neutral-900 mb-8 flex items-center gap-4 uppercase tracking-wider">
      ...
      <div className="h-0.5 bg-neutral-200 flex-1 rounded-full relative">
        <div className={`absolute top-0 left-0 h-full bg-[#FF6600] rounded-full ${progressWidth}`} />
      </div>
    </h2>
  );
}
...
function TimelineItem({ 
  ...
  return (
    <div className="relative">
      {/* Timeline Dot */}
      <div className="absolute -left-[43px] top-1.5 w-[22px] h-[22px] rounded-full bg-orange-50 border-4 border-white shadow-sm flex items-center justify-center">
        <div className="w-2.5 h-2.5 rounded-full bg-[#FF6600]" />
      </div>

      <div className="mb-1">
        <span className="text-[#FF6600] font-bold text-sm tracking-wide uppercase">{period}</span>
      </div>
